...
export default function GroupDetail({ groupId }: PageProps) {
  ...
  if (isError) {
    return <div style={{ padding: "2rem", textAlign: "center", color: "red" }}>เกิดข้อผิดพลาดในการโหลดข้อมูลโปรเจค</div>;
  }

  if (isNotFound) {
    return <div style={{ padding: "2rem", textAlign: "center", color: "gray" }}>ไม่พบโปรเจคที่คุณต้องการ</div>;
  }
            ...
            <div className="lg:col-span-3 space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm">{formatDate(new Date(group.createdAt))}</p>
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-muted-foreground">
                        อัพเดทล่าสุด
                      </p>
                      <p className="text-sm">{formatDate(new Date(group.updatedAt))}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ตัวอย่างการใช้ Access Token ในการเรียก API ต้องมี Header ชื่อ
                    Authorization: Bearer YOUR_TOKEN
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ตัวอย่างการใช้ API ด้วย curl:
                  <br />
                  <code className="flex-1 px-3 py-2 bg-muted rounded-md text-sm font-mono">
